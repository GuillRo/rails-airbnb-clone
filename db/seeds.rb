...
user_1 = User.create(email: "john@wagon.be", first_name: "John", last_name: "Dupont", address: "62 rue du mans")
user_2 = User.create(email: "Hector@wagon.be", first_name: "hector", last_name: "Bio", address: "12 rue de la quète")
user_3 = User.create(email: "Helena@wagon.be", first_name: "Helena", last_name: "Macbook", address: "18 rue de la liberté")
...
Booking.create(date_begin: Date.new(2019,2,1), date_end: Date.new(2019,2,3) , status: "booked", user_id: user_1, flat: flat_3)
Booking.create(date_begin: Date.new(2019,3,5), date_end: Date.new(2019,3,7) , status: "booked", user_id: user_2, flat_id: flat_4)
Booking.create(date_begin: Date.new(2019,4,1), date_end: Date.new(2019,4,10) , status: "booked", user_id: user_3, flat_id: flat_1)
Booking.create(date_begin: Date.new(2019,8,17), date_end: Date.new(2019,8,25) , status: "booked", user_id: user_4, flat_id: flat_5)
Booking.create(date_begin: Date.new(2019,3,10), date_end: Date.new(2019,3,14) , status: "booked", user_id: user_5, flat_id: flat_2)

Review.create(content: "Génial, super expérience", score: 4, user_id: user_1, flat_id: flat_3)
Review.create(content: "Déçu par la propreté et la qualité du matelas", score: 1, user_id: user_2, flat_id: flat_1)
Review.create(content: "Ideal pour un weekend en amoureux", score: 4, user_id: user_3, flat_id: flat_4)
...
FlatAmenity.create(flat_id: flat_3, amenity_id: amen_4)
